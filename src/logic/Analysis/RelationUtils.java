...
public class RelationUtils {
   ...
   */
  public boolean relationNameAlreadyExists(String name,
	  ArrayList<RelationSchema> schema) {
   ...
   * 
   * @param schema
   *          the RelationSchema to get the Keys from
   ...
   * 
   * @param fd
   *          Functional Dependency to work with
   * @param attributes
   *          Attributes to look for
   * @return true if the fd contains the attributes, false if not
   */
  public boolean isFdContainingGivenAttributes(FunctionalDependency fd,
